    ...
    <main className="page-shell max-w-5xl">
      ...
      <Card className="mt-4 overflow-hidden p-0">
        ...
        <div className="grid gap-6 p-6 md:grid-cols-[1fr_300px] md:p-8">
          <div><h2 className="text-xl font-black text-blue-950">Informações do local</h2><p className="mt-3 leading-7 text-slate-600">{location.description}</p><div className="mt-5 grid gap-3 sm:grid-cols-2"><div className="rounded-3xl bg-blue-50 p-4"><p className="text-xs font-black uppercase tracking-wide text-blue-700">Bloco ou setor</p><p className="mt-1 text-lg font-black text-blue-950">{location.block || "Não informado"}</p></div><div className="rounded-3xl bg-blue-50 p-4"><p className="text-xs font-black uppercase tracking-wide text-blue-700">Localização</p><p className="mt-1 text-lg font-black text-blue-950">Local interno</p></div></div><div className="mt-5 rounded-3xl border border-blue-100 bg-white p-4"><div className="flex gap-3"><Navigation className="text-blue-700"/><div><p className="font-black text-blue-950">Orientação rápida</p><p className="mt-1 text-sm leading-6 text-slate-600">Use esta página como destino do QR Code fixado no campus. Em uma versão futura, ela pode mostrar caminho passo a passo entre setores.</p></div></div></div></div>
