...
export async function Navbar() {
  ...
  return <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/85 backdrop-blur-xl">
    <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3">
      <Link href="/" className="flex items-center gap-2 font-black text-slate-900"><span className="rounded-2xl bg-blue-600 p-2 text-white"><GraduationCap size={20}/></span> Campus Fácil 360</Link>
