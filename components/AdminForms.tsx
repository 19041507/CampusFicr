...
export function LocationForm() {
 ...
 return (
  <form action={action} className="grid gap-4 md:grid-cols-2">
    ...
    <div><label className="label">Tipo</label><input className="input" name="type" placeholder="Serviço, Sala, Laboratório, Coordenação" required /></div>
    <div><label className="label">Bloco ou setor</label><input className="input" name="block" placeholder="Ex.: Bloco A, Recepção, Pátio" /></div>
